    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="space-y-3">
        {runningOrder.length === 0 ? (
          <div className="p-8 text-center bg-[#0E0E16] border border-[#1E1E2C] font-mono text-xs text-zinc-500">
            No approved acts in the running order queue. Approve registrations in the Registrations tab to populate the stage order.
          </div>
        ) : (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <span className="text-zinc-500 text-[11px] block">
                      {(act.category || 'solo').toUpperCase()} • {act.performanceType} • {act.department}
                    </span>
                  </div>
                </div>
